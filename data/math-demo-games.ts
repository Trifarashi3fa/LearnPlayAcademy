...
export const mathDemoGames: MathDemoGame[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        visualPrompt: ["apple", "apple", "apple", "apple", "+", "apple", "apple", "apple"],
        choices: ["5", "6", "7", "8"],
        correctAnswer: "7",
        hint: "Count every fruit, not only one kind.",
        stepByStep: ["There are 4 apples.", "There are 3 more apples.", "4 + 3 = 7."],
        visualExplanation: "4 apples + 3 apples = 7 fruit treasures",
