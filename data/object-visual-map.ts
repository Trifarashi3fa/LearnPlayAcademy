export const objectVisualMap = {
  ...
  mushroom: { singular: "mushroom", plural: "mushrooms", kind: "mushroom" },
  pinecone: { singular: "pinecone", plural: "pinecones", kind: "pinecone" },
  bee: { singular: "bee", plural: "bees", kind: "bee" },
