        ...
        <div className="mx-auto grid max-w-6xl gap-8 px-5 py-14 lg:grid-cols-[1fr_420px] lg:items-center lg:px-8">
          <div>
            ...
            <h1 className="mt-3 text-5xl font-black leading-tight md:text-6xl">
              Enter the Free English Forest World.
            </h1>
            <p className="mt-4 max-w-3xl text-lg font-bold leading-8 text-[#5B6B94]">
              Year 1 children practise letters, sounds, vocabulary, simple sentences, grammar, and early reading through the same 10-level Forest World structure.
            </p>
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              <Link
                href="/english/world-map"
          ...
          <div className="overflow-hidden rounded-[2rem] border border-[#DDE8F5] bg-white shadow-playful">
            <Image
              ...
              alt="Forest World English adventure"
              width={520}
              height={380}
            ...
            <div className="p-5">
              <div className="mb-2 flex justify-between text-sm font-black">
                <span>English Forest World Progress</span>
        ...
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-base font-bold leading-7 text-[#5B6B94]">
              Every level has a larger source pool. LearnPlay picks 10 questions each session so replay feels fresh.
            </p>
          </div>
          <Link
            href="/english/world-map"
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
          {englishLevels.map((level) => {
            ...
            return unlocked ? (
              <Link
                key={level.level}
                href={`/english/level/${level.level}`}
