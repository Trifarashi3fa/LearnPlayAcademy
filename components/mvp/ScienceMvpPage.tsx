        ...
        <div className="mx-auto grid max-w-6xl gap-8 px-5 py-14 lg:grid-cols-[1fr_420px] lg:items-center lg:px-8">
          <div>
            ...
            <h1 className="mt-3 text-5xl font-black leading-tight md:text-6xl">
              Explore the Free Science Forest World.
            </h1>
            <p className="mt-4 max-w-3xl text-lg font-bold leading-8 text-[#5B6B94]">
              Year 1 children observe living things, plants, animals, senses, weather, water, materials, and the environment through 10 Forest World missions.
            </p>
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              <Link
                href="/science/world-map"
          ...
          <div className="overflow-hidden rounded-[2rem] border border-[#DDE8F5] bg-white shadow-playful">
            <Image
              ...
              alt="Forest World Science adventure"
              width={520}
              height={380}
            ...
            <div className="p-5">
              <div className="mb-2 flex justify-between text-sm font-black">
                <span>Science Forest World Progress</span>
        ...
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-base font-bold leading-7 text-[#5B6B94]">
              Each level has 12 source questions. LearnPlay picks 10 each session so children can replay and practise.
            </p>
          </div>
          <Link
            href="/science/world-map"
            className="inline-flex min-h-12 items-center justify-center rounded-full bg-[#22C55E] px-6 py-3 text-base font-black text-white shadow-sm transition hover:-translate-y-0.5 focus:outline-none focus:ring-4 focus:ring-[#0B63F6]/25"
          >
            Open World Map
          </Link>
        </div>
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
          {scienceLevels.map((level) => {
            ...
            const content = (
              <article className={`h-full rounded-[1.5rem] border bg-white p-4 shadow-sm transition ${
                ...
                <p className="mt-2 text-sm font-bold leading-6 text-[#5B6B94]">
                  {level.sessionQuestionCount ?? 10} questions per session
                </p>
            ...
            return unlocked ? (
              <Link
                key={level.level}
                href={`/science/level/${level.level}`}
